...
namespace PeninsulaRV.secure
{
    public partial class NewWorkOrder : System.Web.UI.Page
    {
        ...
        private void FillReview()
        {
            ...
            plhReview.Controls.Add(new LiteralControl("<div class='row'>"));
            plhReview.Controls.Add(new LiteralControl("<div class='col-sm-6'><strong>Order Number:</strong></div>"));
            plhReview.Controls.Add(new LiteralControl("<div class='col-sm-6'>" + workOderInfo.OrderNumber + "</div>"));
            plhReview.Controls.Add(new LiteralControl("</div>"));
            plhReview.Controls.Add(new LiteralControl("<div class='row'>"));
            plhReview.Controls.Add(new LiteralControl("<div class='col-sm-6'><strong>Date Ordered:</strong></div>"));
            plhReview.Controls.Add(new LiteralControl("<div class='col-sm-6'>" + workOderInfo.DateOrdered.ToString("d") + "</div>"));
            plhReview.Controls.Add(new LiteralControl("<div class='row'>"));
            plhReview.Controls.Add(new LiteralControl("<div class='col-sm-6'><strong>Mileage:</strong></div>"));
            plhReview.Controls.Add(new LiteralControl("<div class='col-sm-6'>" + workOderInfo.Mileage + "</div>"));
            plhReview.Controls.Add(new LiteralControl("</div>"));
            plhReview.Controls.Add(new LiteralControl("<div class='row'>"));
            plhReview.Controls.Add(new LiteralControl("<div class='col-sm-6'><strong>Order Taken By:</strong></div>"));
            plhReview.Controls.Add(new LiteralControl("<div class='col-sm-6'>" + workOderInfo.TakenBy + "</div>"));
            plhReview.Controls.Add(new LiteralControl("</div>"));
            plhReview.Controls.Add(new LiteralControl("<div class='row'>"));
            plhReview.Controls.Add(new LiteralControl("<div class='col-sm-12'><hr></div>"));
            plhReview.Controls.Add(new LiteralControl("</div>"));
            plhReview.Controls.Add(new LiteralControl("</div>"));

            plhReview.Controls.Add(new LiteralControl("<div class='row'>"));
            plhReview.Controls.Add(new LiteralControl("<div class='col-sm-6'><strong>Labor Tax Exempt:</strong></div>"));
            plhReview.Controls.Add(new LiteralControl("<div class='col-sm-6'><span class='glyphicon glyphicon-edit' aria-hidden='true'></span> " + workOderInfo.ExemptLabor.ToString()));

            pnlReview.Controls.Add(new LiteralControl("<div id='divEditLaborExempt'>"));
            
            RadioButtonList rblEditLaborExempt = new RadioButtonList();
            rblEditLaborExempt.ID = "rblEditLaborExempt";
            rblEditLaborExempt.Items.Add(new ListItem("Exempt", true.ToString()));
            rblEditLaborExempt.Items.Add(new ListItem("Not Exempt", false.ToString()));
            rblEditLaborExempt.Items[0].Selected = workOderInfo.ExemptMaterial;
            rblEditLaborExempt.Items[1].Selected = !workOderInfo.ExemptMaterial;
            plhReview.Controls.Add(rblEditLaborExempt);

            LinkButton lbnEditLaborExempt = new LinkButton();
            lbnEditLaborExempt.Text = "update labor tax status.";
            lbnEditLaborExempt.Command += new CommandEventHandler(UpdateLaborTaxStatus);
            plhReview.Controls.Add(lbnEditLaborExempt);
            ...
            plhReview.Controls.Add(new LiteralControl("<div class='row'>"));
            plhReview.Controls.Add(new LiteralControl("<div class='col-sm-6'><strong>Materials Tax Exempt:</strong></div>"));
            plhReview.Controls.Add(new LiteralControl("<div class='col-sm-6'><span class='glyphicon glyphicon-edit' aria-hidden='true'></span> " + workOderInfo.ExemptMaterial.ToString()));

            pnlReview.Controls.Add(new LiteralControl("<div id='divEditMaterialExempt'>"));

            RadioButtonList rblEditMaterialExempt = new RadioButtonList();
            rblEditMaterialExempt.Items.Add(new ListItem("Exempt", true.ToString()));
            rblEditMaterialExempt.Items.Add(new ListItem("Not Exempt", false.ToString()));
            rblEditMaterialExempt.Items[0].Selected = workOderInfo.ExemptMaterial;
            rblEditMaterialExempt.Items[1].Selected = !workOderInfo.ExemptMaterial;
            plhReview.Controls.Add(rblEditMaterialExempt);

            LinkButton lbnEditMaterialsExempt = new LinkButton();
            lbnEditMaterialsExempt.Text = "update material tax status.";
            lbnEditMaterialsExempt.Command += new CommandEventHandler(UpdateMaterialsTaxStatus);
            plhReview.Controls.Add(lbnEditMaterialsExempt);
            ...
            plhReview.Controls.Add(new LiteralControl("</div>"));
            plhReview.Controls.Add(new LiteralControl("<div class='row'>"));
            plhReview.Controls.Add(new LiteralControl("<div class='col-sm-6'><strong>Job Total: </strong></div>"));
            plhReview.Controls.Add(new LiteralControl("<div class='col-sm-6'>" + workOderInfo.JobTotal.ToString("C") + "</div>"));
            plhReview.Controls.Add(new LiteralControl("</div>"));
            plhReview.Controls.Add(new LiteralControl("<div class='row'>"));
            plhReview.Controls.Add(new LiteralControl("<div class='col-sm-6'><strong>Material Total: </strong></div>"));
            plhReview.Controls.Add(new LiteralControl("<div class='col-sm-6'>" + workOderInfo.MaterialTotal.ToString("C") + "</div>"));
            plhReview.Controls.Add(new LiteralControl("</div>"));
            plhReview.Controls.Add(new LiteralControl("<div class='row'>"));
            plhReview.Controls.Add(new LiteralControl("<div class='col-sm-6'><strong>Miscellaneous Total: </strong></div>"));
            plhReview.Controls.Add(new LiteralControl("<div class='col-sm-6'>" + workOderInfo.MiscellaneousTotal.ToString("C") + "</div>"));
            plhReview.Controls.Add(new LiteralControl("</div>"));
            plhReview.Controls.Add(new LiteralControl("<div class='row'>"));
            plhReview.Controls.Add(new LiteralControl("<div class='col-sm-6'><strong>Subtotal: </strong></div>"));
            plhReview.Controls.Add(new LiteralControl("<div class='col-sm-6'>" + workOderInfo.SubTotal.ToString("C") + "</div>"));
            plhReview.Controls.Add(new LiteralControl("</div>"));
            plhReview.Controls.Add(new LiteralControl("<div class='row'>"));
            plhReview.Controls.Add(new LiteralControl("<div class='col-sm-6'><strong>Sales Tax: </strong></div>"));
            plhReview.Controls.Add(new LiteralControl("<div class='col-sm-6'>" + workOderInfo.SalesTax.ToString("C") + "</div>"));
            plhReview.Controls.Add(new LiteralControl("</div>"));
            plhReview.Controls.Add(new LiteralControl("<div class='row'>"));
            plhReview.Controls.Add(new LiteralControl("<div class='col-sm-6'><strong>Grand Total: </strong></div>"));
            plhReview.Controls.Add(new LiteralControl("<div class='col-sm-6'>" + workOderInfo.GrandTotal.ToString("C") + "</div>"));
            plhReview.Controls.Add(new LiteralControl("</div>"));
        ...
        private void UpdateLaborTaxStatus(object sender, CommandEventArgs e)
        {
            WorkOrderInfo workorder = new WorkOrderInfo();
            workorder.OrderNumber = hdnOrderNumber.Value;
            RadioButtonList rblEditLaborExempt = new RadioButtonList();
            rblEditLaborExempt = plhReview.FindControl("rblEditLabor") as RadioButtonList;
            workorder.ExemptLabor = rblEditLaborExempt.Items[0].Selected;

            workorder.UpdateLaborTaxStatus();

            FillReview();
        }

        private void UpdateMaterialsTaxStatus(object sender, CommandEventArgs e)
        {
            WorkOrderInfo workorder = new WorkOrderInfo();
            workorder.OrderNumber = hdnOrderNumber.Value;
            RadioButtonList rblEditMaterialsExempt = new RadioButtonList();
            rblEditMaterialsExempt = plhReview.FindControl("rblEditMaterials") as RadioButtonList;
            workorder.ExemptLabor = rblEditMaterialsExempt.Items[0].Selected;

            workorder.UpdateMaterialsTaxStatus();
