<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" Debug="true" AutoEventWireup="true" CodeBehind="ConsignmentAgreement.aspx.cs" Inherits="PeninsulaRV.secure.ConsignmentAgreement2" %>
        ...
        <div class="tab-content">
            <div id="AddConsignment" class="tab-pane fade in active">
                ...
                <div class="row form-group">
                    ...
                    <asp:RequiredFieldValidator ValidationGroup="AddConsignment" runat="server" Display="Dynamic" ControlToValidate="rblDealType"
                            CssClass="text-danger" ErrorMessage="The deal type field is required." />
                </div>

                <div class="row form-group">
                    <asp:Label runat="server" AssociatedControlID="txtDealCalc" CssClass="col-md-2 control-label">Commission Calc (eg %, escess of, fee amount):</asp:Label>
                    <div class="col-md-4">
                        <asp:TextBox runat="server" ID="txtDealCalc" Text="10" CssClass="form-control" /><br />
                        <asp:RequiredFieldValidator ValidationGroup="AddConsignment" runat="server" Display="Dynamic" ControlToValidate="txtDealCalc" CssClass="text-danger" ErrorMessage="The commission calculation field is required." />
                    </div>
                </div>                
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-4">
                        <asp:TextBox runat="server" ID="txtAskingPrice" CssClass="form-control" /><br />
                        <asp:RequiredFieldValidator ValidationGroup="AddConsignment" Display="Dynamic" runat="server" ControlToValidate="txtAskingPrice"
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-4">
                        <asp:TextBox runat="server" ID="txtTerm" CssClass="form-control" /><br />
                        <asp:RequiredFieldValidator ValidationGroup="AddConsignment" Display="Dynamic" runat="server" ControlToValidate="txtTerm"
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-4">
                        <asp:TextBox runat="server" ID="txtLienHolder" Text="None" CssClass="form-control" /><br />
                    </div>
                </div>
                <div class="row form-group">
                    <asp:Label runat="server" AssociatedControlID="txtbalanceOwed" CssClass="col-md-2 control-label">Balance Owed:</asp:Label>
                    <div class="col-md-4">
                        <asp:TextBox runat="server" ID="txtBalanceOwed" Text="0" CssClass="form-control" /><br />                        
                    </div>
                </div>                
        ...
        <div class="row">
            ...
            <div class="col-sm-4">
                ...
                <div id="divCommissionCalc" style="display: none">
                    <asp:TextBox ID="txtEditDealCalc" CssClass="form-control" runat="server" />
                    <asp:LinkButton OnCommand="Updatesale" CommandArgument="DealCalc" Text="" runat="server">Update Commission</asp:LinkButton>
                </div>
                ...
                <a href="javascript: toggleDiv('divTerm');"> <span class="glyphicon glyphicon-edit"></span></a>
                <strong>Term: </strong><asp:Label ID="lblSaleReviewTerm" runat="server" /><br />
                <div id="divTerm" style="display: none">
                    <asp:TextBox ID="txtEditTerm" CssClass="form-control" runat="server" />
                    <asp:LinkButton OnCommand="Updatesale" CommandArgument="Term" Text="" runat="server">Update Term</asp:LinkButton>
                </div>
